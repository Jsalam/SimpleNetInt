...
function getTextBoxContent(evt) {
    ...
    colorFactory_1.ColorFactory.makeDictionary(DOMManager_1.DOM.textboxes.edgeKinds.value, colorFactory_1.ColorFactory.getCategoricalPalette('palette2'), "connectors");
}
